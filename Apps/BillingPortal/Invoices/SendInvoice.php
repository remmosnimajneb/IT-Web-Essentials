	...
	$EmailMessage = "<!DOCTYPE html PUBLIC \"-//W3C//DTD XHTML 1.0 Transitional//EN\" \"http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd\">
		               ...
		               <table width=\"100%\" cellspacing=\"0\" cellpadding=\"0\" style=\"mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;\"> 
		                 <tr style=\"border-collapse:collapse;\"> 
		                  <td width=\"560\" valign=\"top\" align=\"center\" style=\"padding:0;Margin:0;\"> 
		                   <table width=\"100%\" cellspacing=\"0\" cellpadding=\"0\" role=\"presentation\" style=\"mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;\"> 
		                     <tr style=\"border-collapse:collapse;\"> 
		                      <td style=\"padding:0;Margin:0;font-size:0px;\" align=\"center\"><img class=\"adapt-img\" src=\"" . GetSysConfig("SystemAdminURL") . GetSysConfig("InvoiceBrandingLogo") . "\" alt style=\"display:block;border:0;outline:none;text-decoration:none;-ms-interpolation-mode:bicubic;\"></td> 
		                     </tr> 
		                     <tr style=\"border-collapse:collapse;\"> 
		                      <td align=\"center\" style=\"padding:0;Margin:0;padding-top:25px;\"><p style=\"Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-size:18px;font-family:lato, 'helvetica neue', helvetica, arial, sans-serif;line-height:27px;color:#666666;\">" . GetSysConfig("SiteTitle") . ", <br>" . GetSysConfig("BrandingFooterPhoneNumber") . "</p></td> 
		                     </tr> 
		                   </table></td> 
		                 </tr> 
		               </table></td> 
		...
		if(USE_EXTERNAL_STMP == 1){
			...
			try{
				...
				$mail->setFrom(SMTP_SendEmailsFromAddress, GetSysConfig("SiteTitle"));                         
					
					/* Get Send To Emails*/
						$Query = "SELECT * FROM `ClientUser` WHERE `ClientID` = '" . $Invoice['ClientID'] . "' AND `ReceivesInvoices` = 1";
						$stm = $DatabaseConnection->prepare($Query);
					    $stm->execute();
					    $ClientUsers = $stm->fetchAll();

					    if($stm->rowCount() > 0){
					    	foreach ($ClientUsers as $Contact) {
