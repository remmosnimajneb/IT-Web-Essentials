...
require 'Assets/PHPMailer/src/SMTP.php';
    ...
    $Invoice = "SELECT * FROM `Invoice` AS I INNER JOIN `Clients` AS C ON C.`ClientID` = I.`ClientID` WHERE `InvoiceID` = '" . EscapeSQLEntry($_GET['ID']) . "'";
		                 ...
		                 <tr style=\"border-collapse:collapse;\"> 
		                  <td width=\"600\" valign=\"top\" align=\"center\" style=\"padding:0;Margin:0;\"> 
		                   <table style=\"mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:separate;border-spacing:0px;background-color:#FFFFFF;border-radius:4px;\" width=\"100%\" cellspacing=\"0\" cellpadding=\"0\" bgcolor=\"#ffffff\" role=\"presentation\"> 
		                     <tr style=\"border-collapse:collapse;\"> 
		                      <td align=\"center\" style=\"Margin:0;padding-bottom:5px;padding-left:30px;padding-right:30px;padding-top:35px;\"><h1 style=\"Margin:0;line-height:58px;mso-line-height-rule:exactly;font-family:lato, 'helvetica neue', helvetica, arial, sans-serif;font-size:48px;font-style:normal;font-weight:normal;color:#111111;\">Dear Customer,<br></h1></td> 
		                     </tr> 
		                     <tr style=\"border-collapse:collapse;\"> 
		                 ...
		                 <tr style=\"border-collapse:collapse;\"> 
		                  <td width=\"600\" valign=\"top\" align=\"center\" style=\"padding:0;Margin:0;\"> 
		                   <table style=\"mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:separate;border-spacing:0px;border-radius:4px;background-color:#111111;\" width=\"100%\" cellspacing=\"0\" cellpadding=\"0\" bgcolor=\"#111111\" role=\"presentation\"> 
		                     ...
		                     <tr style=\"border-collapse:collapse;\"> 
		                      <td esdev-links-color=\"#7c72dc\" align=\"left\" style=\"Margin:0;padding-top:20px;padding-left:30px;padding-right:30px;padding-bottom:40px;\"><a target=\"_blank\" href=\"mailto:" . $InvoiceEmailAddress . "\" style=\"-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:lato, 'helvetica neue', helvetica, arial, sans-serif;font-size:18px;text-decoration:underline;color:#7C72DC;\">Email us at " . $InvoiceEmailAddress . "</a></td> 
		                     </tr> 
		                   </table></td> 
		                 </tr> 
		               </table></td> 
		               ...
		               <table width=\"100%\" cellspacing=\"0\" cellpadding=\"0\" style=\"mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;\"> 
		                 <tr style=\"border-collapse:collapse;\"> 
		                  <td width=\"560\" valign=\"top\" align=\"center\" style=\"padding:0;Margin:0;\"> 
		                   <table width=\"100%\" cellspacing=\"0\" cellpadding=\"0\" role=\"presentation\" style=\"mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;\"> 
		                     <tr style=\"border-collapse:collapse;\"> 
		                      <td style=\"padding:0;Margin:0;font-size:0px;\" align=\"center\"><img class=\"adapt-img\" src=\"" . $SystemAdminURL . $InvoiceBrandingLogo . "\" alt style=\"display:block;border:0;outline:none;text-decoration:none;-ms-interpolation-mode:bicubic;\"></td> 
		                     </tr> 
		                     <tr style=\"border-collapse:collapse;\"> 
		                      <td align=\"center\" style=\"padding:0;Margin:0;padding-top:25px;\"><p style=\"Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-size:18px;font-family:lato, 'helvetica neue', helvetica, arial, sans-serif;line-height:27px;color:#666666;\">" . $SiteTitle . ", <br>" . $BrandingFooterPhoneNumber . "</p></td> 
		                     </tr> 
		                   </table></td> 
		                 </tr> 
		               </table></td> 
	...
	try{
		...
		$mail->addBCC("help@bermangroup.com");   
	...
	header('Location: /System/BillingPortal/Invoices');
?>